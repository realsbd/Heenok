...
Route::middleware('auth')->group(function () {
    Route::post('story/upload', [StoryController::class, 'upload']);
    Route::get('story/view/{storyId}', [StoryController::class, 'viewStory']);
    Route::post('story/{storyId}/react', [StoryController::class, 'reactToStory']);
});
